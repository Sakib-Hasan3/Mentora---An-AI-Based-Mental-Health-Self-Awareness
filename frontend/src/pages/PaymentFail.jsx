  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>পেমেন্ট ব্যর্থ হয়েছে</h1>
        <p style={styles.subtitle}>
          দুঃখিত, কোনো একটি ত্রুটির কারণে আপনার পেমেন্টটি সম্পন্ন করা সম্ভব হয়নি। আপনার অ্যাকাউন্ট থেকে কোনো টাকা কাটা হয়নি।
        </p>
        ...
        <div style={styles.infoBox}>
          ...
          <div style={styles.infoRow}>
            ...
            <span style={{ ...styles.infoValue, color: '#ef4444', fontWeight: 'bold' }}>FAILED</span>
          </div>
        </div>
